...
# Inject GTM
inject_gtm('GTM-5N2NNDML')  # Replace with your actual GTM ID
...
def home():
    ...
    st.write("Welcome to the advanced Streamlit app. Use the sidebar to navigate through different sections.")
